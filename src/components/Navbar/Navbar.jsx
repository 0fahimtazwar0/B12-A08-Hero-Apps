...
const Navbar = () => {
    ...
    return (
        <div className='bg-white flex justify-between items-center max-width h-[78px] py-4 border-b-[1px] border-[#E9E9E9] mb-20'>
            ...
            <div>
                <ul className='font-medium text-[#000000e6] flex gap-8 nav-links'>
